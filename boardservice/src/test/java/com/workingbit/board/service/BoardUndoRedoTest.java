...
public class BoardUndoRedoTest extends BaseServiceTest {
  ...
  public void should_undo() {
    ...
    board = boardService().move(squareC3, squareD4, board, articleId, boardBox.getNotation().getNotationDrives());
  ...
  public void should_undo_2() {
    ...
    board = boardService().move(squareD4, squareE5, board, articleId, boardBox.getNotation().getNotationDrives());
