...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = Article.class, name = Article.CLASS_NAME),
    @JsonSubTypes.Type(value = Articles.class, name = "Articles"),
    @JsonSubTypes.Type(value = BoardBox.class, name = BoardBox.CLASS_NAME),
    @JsonSubTypes.Type(value = BoardBoxes.class, name = "BoardBoxes"),
    @JsonSubTypes.Type(value = Board.class, name = Board.CLASS_NAME),
