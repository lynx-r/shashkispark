...
public class ErrorMessages {
  ...
  public static final String UNABLE_TO_REGISTER = "Не удалось зарегистрироваться";
  public static final String UNABLE_TO_AUTHORIZE = "Не удалось получить права на ресурс";
